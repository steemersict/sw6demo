...
<head>
    ...
    <link rel="icon" type="image/png" sizes="16x16" href="<?= $baseUrl; ?>../common/assets/images/favicon/favicon-16x16.png">
    <link rel="icon" type="image/png" sizes="32x32" href="<?= $baseUrl; ?>../common/assets/images/favicon/favicon-32x32.png">
    ...
    <link rel="stylesheet" type="text/css" href="<?= $baseUrl; ?>../common/assets/styles/fonts.css" media="all"/>
...
<header class="header-main">
    <div class="header-main__branding">
        <img class="header-main__logo" src="<?= $baseUrl; ?>../common/assets/images/sw-logo-blue.svg" width="148" alt="Shopware">
